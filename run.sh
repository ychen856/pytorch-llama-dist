...
python3 algrithm_ppl_test3.py --config config_nrp.yaml --selection 6 2>&1|tee u_jetson_batch_10_4_alg.log
python3 algrithm_ppl_test3.py --config config_nrp.yaml --selection 7 2>&1|tee u_jetson_batch_20_2_alg.log
python3 algrithm_ppl_test3.py --config config_nrp.yaml --selection 8 2>&1|tee u_jetson_batch_20_4_alg.log