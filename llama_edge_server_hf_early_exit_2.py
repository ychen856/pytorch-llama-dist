# this code is used for edge server computation that
# receives original data from the client, does the calculation, and
# send the output to the server after compressed the data
import gc
import math
import threading
